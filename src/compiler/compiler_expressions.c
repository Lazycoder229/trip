...
static int resolveBuiltin(const char* name, int len) {
    struct { const char* nm; int id; } tbl[] = {
        ...
        {"mysqlConnect",      BUILTIN_MYSQL_CONNECT},
        {"mysqlQuery",        BUILTIN_MYSQL_QUERY},
        {"mysqlEscape",       BUILTIN_MYSQL_ESCAPE},
        {"mysqlLastInsertId", BUILTIN_MYSQL_LAST_INSERT_ID},
        {"mysqlError",        BUILTIN_MYSQL_ERROR},
        {"mysqlClose",        BUILTIN_MYSQL_CLOSE},
        // ── New MySQL builtins ─────────────────────────────────────────
        {"mysqlPing",         BUILTIN_MYSQL_PING},
        {"mysqlAffectedRows", BUILTIN_MYSQL_AFFECTED_ROWS},
        {"mysqlQueryMulti",   BUILTIN_MYSQL_QUERY_MULTI},
        {"mysqlInsertBatch",  BUILTIN_MYSQL_INSERT_BATCH},
        {"mysqlBegin",        BUILTIN_MYSQL_BEGIN},
        {"mysqlCommit",       BUILTIN_MYSQL_COMMIT},
        {"mysqlRollback",     BUILTIN_MYSQL_ROLLBACK},
        {"mysqlPrepare",      BUILTIN_MYSQL_PREPARE},
        {"mysqlExecute",      BUILTIN_MYSQL_EXECUTE},
        {"mysqlStmtClose",    BUILTIN_MYSQL_STMT_CLOSE},
        {"mysqlPoolCreate",   BUILTIN_MYSQL_POOL_CREATE},
        {"mysqlPoolGet",      BUILTIN_MYSQL_POOL_GET},
        {"mysqlPoolRelease",  BUILTIN_MYSQL_POOL_RELEASE},
        {"mysqlPoolClose",    BUILTIN_MYSQL_POOL_CLOSE},
